...
export const Room = forwardRef((props, ref) => {
  const { nodes, materials } = useGLTF("/models/hero/optimized-room.glb");
  ...
  const pillowMaterial = new THREE.MeshPhongMaterial({ color: "#d90429" });
...
useGLTF.preload("/models/hero/optimized-room.glb");
